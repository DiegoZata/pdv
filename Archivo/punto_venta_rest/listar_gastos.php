...
if($codigo == "" && $id_pedido == "" && $fecha_desde == "" && $fecha_hasta == ""){
   ...
   /* if($id_pedido != ""){
    ...
    if($fecha_desde != "" && $fecha_hasta != ""){
        $sentencia_sql = $sentencia_sql." AND gastos.fecha BETWEEN '$fecha_desde 00:00:00' AND '$fecha_hasta 23:59:59'";
    }

    if($fecha_desde != ""){
        $sentencia_sql = $sentencia_sql." AND gastos.fecha > '$fecha_desde 00:00:00'";
    }

    if($fecha_hasta != ""){
        $sentencia_sql = $sentencia_sql." AND gastos.fecha < '$fecha_hasta 23:59:59'";
    }

    $sentencia_sql = $sentencia_sql." ORDER BY gastos.id_gasto DESC";
